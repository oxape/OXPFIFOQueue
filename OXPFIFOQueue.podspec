#
#  Be sure to run `pod spec lint OXPFIFOQueue.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/oxape/OXPFIFOQueue.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "OXPFIFOQueue", "OXPFIFOQueue/**/*.{h,m}"
  s.exclude_files = ""
